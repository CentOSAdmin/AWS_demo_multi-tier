...
# VPC variables
vpc_name             = "demo-vpc"
vpc_cidr             = "172.20.0.0.0/16"
vpc_azs              = ["eu-central-1a", "eu-central-1b", "eu-central-1c"]
vpc_public_subnets   = ["172.20.1.0/24", "172.20.2.0/24", "172.20.3.0/24"]
vpc_private_subnets  = ["172.20.4.0/24", "172.20.5.0/24", "172.20.6.0/24"]
vpc_database_subnets = ["172.20.7.0/24", "172.20.8.0/24", "172.20.9.0/24"]
...
asg_image_id                            = "ami-0669b163befffbdfc"
